    ...
    >
      ...
      >
        {features.map((feature) => (
          ...
          >
            <a href={feature.link} target="_blank" rel="noopener noreferrer" style={{ width: '40%' }}>
              <motion.img
                src={feature.image}
                alt={feature.title}
                style={{
            ...
            <div style={{ width: '50%', padding: '1rem' }}>
              <h3 style={{ fontSize: '2rem', marginBottom: '1rem', color: '#000' }}>{feature.title}</h3> {/* Updated color */}
